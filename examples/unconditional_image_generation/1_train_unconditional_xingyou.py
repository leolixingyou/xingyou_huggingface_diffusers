...
from accelerate.utils import ProjectConfiguration, write_basic_config
...
write_basic_config()
# login('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')
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        ##xingyou
        ### Default is None, I changed to huggan/flowers-102-categories
    ...
    parser.add_argument(
        ...
        type=int,
        ##xingyou
        ### 64 for testing program and 256 for working
        # default=64,
        default=256,
        help=(
